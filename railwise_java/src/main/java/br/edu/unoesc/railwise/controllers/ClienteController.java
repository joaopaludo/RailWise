...
public class ClienteController {
     ...
     */
    @PutMapping(value = "/{id}")
    public ResponseEntity<Cliente> putCliente(@PathVariable("id") Integer id, @RequestBody Cliente cliente) {
    ...
    public ResponseEntity<Boolean> deleteCliente(@PathVariable("id") Integer id) {

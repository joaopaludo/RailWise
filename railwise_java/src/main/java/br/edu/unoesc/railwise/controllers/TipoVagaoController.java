...
public class TipoVagaoController {
    ...
    @GetMapping(value = "/{id}")
    @ResponseBody
    public ResponseEntity<TipoVagao> getTipoVagao(@PathVariable("id") Integer id) {
     ...
     */
    @PutMapping(value = "/{id}")
    public ResponseEntity<TipoVagao> putTipoVagao(@PathVariable("id") Integer id, @RequestBody TipoVagao tipoVagao) {
    ...
    public ResponseEntity<Boolean> deleteTipoVagao(@PathVariable("id") Integer id) {

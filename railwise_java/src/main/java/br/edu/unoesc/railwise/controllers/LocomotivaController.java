...
public class LocomotivaController {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<Locomotiva> findById(@PathVariable Integer id) {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<Locomotiva> update(@PathVariable Integer id, @RequestBody Locomotiva locomotiva) {

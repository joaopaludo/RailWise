...
public class TipoFuncionarioController {
    ...
    @GetMapping(value = "/{id}")
    @ResponseBody
    public ResponseEntity<TipoFuncionario> getTipoFuncionario(@PathVariable("id") Integer id) {
     ...
     */
    @PutMapping(value = "/{id}")
    public ResponseEntity<TipoFuncionario> putTipoFuncionario(@PathVariable("id") Integer id,
    ...
    public ResponseEntity<Boolean> deleteTipoFuncionario(@PathVariable("id") Integer id) {
